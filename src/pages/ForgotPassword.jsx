    ...
    <section>
        ...
        <div className='flex  justify-between flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
            <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
                ...
                alt="keys"  className='w-full rounded-2xl '/>
            </div>
                ...
                <form on onSubmit={onSubmit}>
                    ...
                    <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                        <p className='mb-6'>Don't have a account? 
                            <Link to="/sign-up" className='text-red-600 hover:text-red-800 transition duration-200 ease-in-out m-1'>Register</Link>
                            </p>
                        <p>
                    ...
                    hover:shadow-lg active:bg-blue-800'>Send Reset Password Email</button>
                <div className='my-4 before:border-t before:flex-1 flex after:border-t after:flex-1 items-center '>
